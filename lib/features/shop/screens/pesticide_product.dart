...
class PesticideProducts extends StatefulWidget {
  const PesticideProducts({super.key});

  @override
  State<PesticideProducts> createState() => _PesticideProductsState();
}

class _PesticideProductsState extends State<PesticideProducts> {
  late Future<List<ProductsModel>> futureProducts;

  @override
  void initState() {
    super.initState();
    futureProducts = ProductsController().getAllFertilizerData();
  }
