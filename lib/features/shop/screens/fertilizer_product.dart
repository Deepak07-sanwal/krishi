...
class FertilizerProducts extends StatefulWidget {
  const FertilizerProducts({super.key});

  @override
  State<FertilizerProducts> createState() => _FertilizerProductsState();
}

class _FertilizerProductsState extends State<FertilizerProducts> {
  late Future<List<ProductsModel>> futureProducts;

  @override
  void initState() {
    super.initState();
    futureProducts = ProductsController().getAllPesticideData();
  }
